package com.jetpackcompose.todo.di

import android.content.Context
import androidx.room.Room
import com.jetpackcompose.todo.data.local.TodoDao
import com.jetpackcompose.todo.data.local.TodoDatabase
...
@Singleton
 ...
 fun provideLocalDatabase(@ApplicationContext context: Context):TodoDatabase{
    ...
    @Provides
    @Singleton
    fun providerTodoRepository(dao:TodoDao):TodoRepository=TodoRepository(dao=dao)
}